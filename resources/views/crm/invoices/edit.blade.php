                    ...
                    <div class="col-6 col-md-4 create-step-1 active-step estimate-form-field-col">
                                    ...
                                    <div class="form-control d-flex flex-column gap-2 bg-light"
                                        ...
                                        <div class="form-check mb-0">
                                            <input class="form-check-input" type="checkbox" id="solar_meter_charges_check"
                                                value="1" @checked((float) old('solar_meter_charges_amount', $invoice->solar_meter_charges_amount) > 0)>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6 estimate-meter-charges-col" id="meter-charges-input" style="display: none;">
                                            ...
                                            <input type="number" min="0" step="1" name="solar_meter_charges_amount"
                                                id="solar_meter_charges_amount"
                                                value="{{ old('solar_meter_charges_amount', $invoice->solar_meter_charges_amount) }}"
                                                class="form-control @error('solar_meter_charges_amount') is-invalid @enderror"
                                                placeholder="0.00">
                                            <div class="invalid-feedback" id="solar_meter_charges_amount-error">
                        ...
                        <div class="col-12 create-step-2">
                            ...
                            <div class="bom-section bg-light rounded-3 p-3 border">
                                ...
                                @php
                                    $generationData = is_array($invoice->generation_data)
                                        ? $invoice->generation_data
                                        : json_decode((string) ($invoice->generation_data ?? '[]'), true);
