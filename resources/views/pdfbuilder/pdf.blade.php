...
<head>
    ...
    <style>
        ...
        * {
        ...
        .pdf-rich-content li ul,
        .pdf-rich-content li ol {
            margin: 2px 0 6px 0;
        }

        .pdf-rich-content li li {
            margin: 0 0 4px 0;
        }
        ...
        .pdf-rich-content-spacious li ul,
        .pdf-rich-content-spacious li ol {
            margin: 2px 0 6px 0;
        }

        .pdf-rich-content-spacious li li {
            margin: 0 0 4px 0;
        }
        ...
        .pdf-company-page-about li ul,
        .pdf-company-page-about li ol {
            margin: 2px 0 6px 0;
        }

        .pdf-company-page-about li li {
            margin: 0 0 4px 0;
        }
...
<body>
<?php
// Resolve custom logo base64 for all pages (passed from controller or fallback)
$_customLogoBase64ForPages = $custom_logo_base64 ?? null;
if (!$_customLogoBase64ForPages && !empty($logoBase64) && str_starts_with($logoBase64, 'data:image')) {
    // Don't use company logo for this - only use explicitly uploaded custom logo
    $_customLogoBase64ForPages = null;
}
?>
    ...
    <!-- ================= SYSTEM INFO (Page 5B) ================= -->
    <?php if ($__timeLineActive0): ?>
    <div class="<?= $_pageClass('p5b') ?>" style="position:relative;background:#fff;z-index:10; page-break-after: always; min-height: 842px;">
        <div style="padding: 20px 42px 30px;">
            @include('pdfbuilder.partials.pdf-page-header')

            <div class="quotation-container pdf-rich-content pdf-company-page-about" style="padding: 16px 0px;">
                <div style="margin-bottom: 20px;">
                    <h2 style="font-size: 18px; color: #222; margin: 0 0 8px 0; text-transform: uppercase;">
                        MODULE MOUNTING STRUCTURE
                    </h2>
                </div>
            
            <p style="font-size: 14px; margin-bottom: 12px; color: #333;">
                Our GI hot-dip galvanized mounting structures are engineered for superior strength, corrosion resistance, and long service life. Designed to withstand harsh weather conditions, they ensure safe and reliable support for solar PV modules.
            </p>
            
            <h4 style="font-size: 14px; color: #333; margin-top: 16px; margin-bottom: 8px;">Features</h4>
            <ul style="font-size: 14px; color: #333; margin-bottom: 20px;">
                <li>High-quality GI structure</li>
                <li>Corrosion-resistant finish</li>
                <li>Designed for high wind loads</li>
                <li>Fast & secure installation</li>
                <li>Low maintenance</li>
                <li>Long operational life</li>
            </ul>

            <h3 style="font-size: 16px; color: #222; text-transform: uppercase; margin-bottom: 8px; margin-top: 24px;">FOUNDATION</h3>
            <p style="font-size: 14px; margin-bottom: 20px; color: #333;">
                The mounting structure is installed on a reinforced concrete foundation designed according to site conditions, soil characteristics, and structural load calculations to ensure maximum stability and durability.
            </p>

            <h3 style="font-size: 16px; color: #222; text-transform: uppercase; margin-bottom: 8px; margin-top: 24px;">SOLAR INVERTER</h3>
            <p style="font-size: 14px; margin-bottom: 12px; color: #333;">
                MBT Solar provides high-efficiency string and hybrid inverters that convert DC power generated by solar panels into usable AC power. Intelligent MPPT technology ensures maximum energy harvesting while offering advanced monitoring and protection features.
            </p>
            
            <h4 style="font-size: 14px; color: #333; margin-top: 16px; margin-bottom: 8px;">Benefits</h4>
            <ul style="font-size: 14px; color: #333; margin-bottom: 20px;">
                <li>High conversion efficiency</li>
                <li>Multiple MPPT technology</li>
                <li>Remote monitoring</li>
                <li>Smart safety protection</li>
                <li>Low maintenance</li>
                <li>Long service life</li>
                <li>Grid-compatible operation</li>
    ...
    <div class="page" style="position: relative; min-height: 842px; background: white;">
        ...
        <div style="padding: 20px 50px 50px 50px;">
            ...
            ?>
            <div style="background-color: #fff; border: 1px solid #dcdcdc; margin-top: 20px; border-radius: 16px; padding: 20px 25px;">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <!-- LEFT COLUMN -->
                        <td width="48%" valign="top" style="border-right: 1px solid #dcdcdc; padding-right: 25px;">
                            <!-- Phone -->
                            <table width="100%" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #dcdcdc;">
                                <tr><td style="padding: 12px 0;">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="50" align="left" valign="middle">
                                                <div style="width: 40px; height: 40px; border-radius: 20px; border: 1px solid #4b9349; background-color: #f4f8f4; text-align: center;">
                                                    <img src="data:image/svg+xml;base64,<?= base64_encode('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#4b9349" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>') ?>" width="18" height="18" style="margin-top: 11px;">
                                                </div>
                                            </td>
                                            <td width="15" align="center" valign="middle">
                                                <div style="width: 2px; height: 30px; background-color: #4b9349;"></div>
                                            </td>
                                            <td align="left" valign="middle" style="padding-left: 10px;">
                                                <div style="font-size: 14px; font-weight: bold; color: #1a1a1a; margin-bottom: 3px; font-family: 'Montserrat', sans-serif;">Phone</div>
                                                <div style="font-size: 12px; color: #444; font-family: 'Montserrat', sans-serif;"><?= !empty($userPhone) ? esc($userPhone) : '--' ?></div>
                                            </td>
                                        </tr>
                                    </table>
                                </td></tr>
                            ...
                            <!-- Email -->
                            <table width="100%" cellpadding="0" cellspacing="0" <?= empty($companySettings['company_tax_id']) ? '' : 'style="border-bottom: 1px solid #dcdcdc;"' ?>>
                                <tr><td style="padding: 12px 0;">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="50" align="left" valign="middle">
                                                <div style="width: 40px; height: 40px; border-radius: 20px; border: 1px solid #4b9349; background-color: #f4f8f4; text-align: center;">
                                                    <img src="data:image/svg+xml;base64,<?= base64_encode('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#4b9349" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>') ?>" width="18" height="18" style="margin-top: 11px;">
                                                </div>
                                            </td>
                                            <td width="15" align="center" valign="middle">
                                                <div style="width: 2px; height: 30px; background-color: #4b9349;"></div>
                                            ...
                                            <td align="left" valign="middle" style="padding-left: 10px;">
                                                <div style="font-size: 14px; font-weight: bold; color: #1a1a1a; margin-bottom: 3px; font-family: 'Montserrat', sans-serif;">Email</div>
                                                <div style="font-size: 12px; color: #444; font-family: 'Montserrat', sans-serif;"><?= !empty($userEmail) ? esc($userEmail) : '--' ?></div>
                                            </td>
                                        </tr>
                                    </table>
                                </td></tr>
                                ...
                                <tr><td style="padding: 12px 0;">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="50" align="left" valign="middle">
                                                <div style="width: 40px; height: 40px; border-radius: 20px; border: 1px solid #4b9349; background-color: #f4f8f4; text-align: center;">
                                                    <img src="data:image/svg+xml;base64,<?= base64_encode('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#4b9349" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="5" x2="5" y2="19"></line><circle cx="6.5" cy="6.5" r="2.5"></circle><circle cx="17.5" cy="17.5" r="2.5"></circle></svg>') ?>" width="18" height="18" style="margin-top: 11px;">
                                                </div>
                                            </td>
                                            <td width="15" align="center" valign="middle">
                                                <div style="width: 2px; height: 30px; background-color: #4b9349;"></div>
                                            ...
                                            <td align="left" valign="middle" style="padding-left: 10px;">
                                                <div style="font-size: 14px; font-weight: bold; color: #1a1a1a; margin-bottom: 3px; font-family: 'Montserrat', sans-serif;">GST NO</div>
                                                <div style="font-size: 12px; color: #444; font-family: 'Montserrat', sans-serif;"><?= esc($companySettings['company_tax_id']) ?></div>
                                            </td>
                                        </tr>
                                    </table>
                                </td></tr>
                        ...
                        <!-- RIGHT COLUMN -->
                        <td width="48%" valign="top" style="padding-left: 25px;">
                            <!-- Website (Visit Us) -->
                            <table width="100%" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #dcdcdc;">
                                <tr><td style="padding: 12px 0;">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="50" align="left" valign="middle">
                                                <div style="width: 40px; height: 40px; border-radius: 20px; border: 1px solid #4b9349; background-color: #f4f8f4; text-align: center;">
                                                    <img src="data:image/svg+xml;base64,<?= base64_encode('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#4b9349" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>') ?>" width="18" height="18" style="margin-top: 11px;">
                                                </div>
                                            </td>
                                            <td width="15" align="center" valign="middle">
                                                <div style="width: 2px; height: 30px; background-color: #4b9349;"></div>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr><td style="padding: 12px 0;">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="50" align="left" valign="top" style="padding-top: 3px;">
                                                <div style="width: 40px; height: 40px; border-radius: 20px; border: 1px solid #4b9349; background-color: #f4f8f4; text-align: center;">
                                                    <img src="data:image/svg+xml;base64,<?= base64_encode('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#4b9349" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>') ?>" width="18" height="18" style="margin-top: 11px;">
                                                </div>
                                            </td>
                                            <td width="15" align="center" valign="top" style="padding-top: 8px;">
                                                <div style="width: 2px; height: 30px; background-color: #4b9349;"></div>
                                            </td>
                                            <td align="left" valign="top" style="padding-left: 10px; padding-top: 3px;">
                                                <div style="font-size: 14px; font-weight: bold; color: #1a1a1a; margin-bottom: 3px; font-family: 'Montserrat', sans-serif;">Address</div>
                                                <div style="font-size: 12px; color: #444; font-family: 'Montserrat', sans-serif; line-height: 1.4;"><?= !empty($userAddress) ? esc($userAddress) : '--' ?></div>
                                            </td>
                                        </tr>
                                    </table>
                                </td></tr>
