...
@php
    ...
    $originalCompanyName = $valueOr($companySettings['company_name'] ?? data_get($preparedUser, 'company') ?? data_get($preparedUser, 'company_name'), 'MBT SOLAR');
    $companyName = $customName ?: $originalCompanyName;
    ...
    <section class="page proposal-page">
        ...
        <div class="prop-footer">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="33%" align="left">{{ $proposalLabel }}</td>
                    <td width="34%" align="center">PAGE 1</td>
                    <td width="33%" align="right">Generated by {{ $originalCompanyName }}</td>
                </tr>
            </table>
        </div>
    </section>
    ...
    <section class="page proposal-page no-header-page">
        ...
        <div class="prop-footer">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="33%" align="left">{{ $proposalLabel }}</td>
                    <td width="34%" align="center">PAGE 2</td>
                    <td width="33%" align="right">Generated by {{ $originalCompanyName }}</td>
                </tr>
            </table>
        </div>
    ...
    <section class="page proposal-page no-header-page">
        ...
        <div class="prop-footer">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="33%" align="left">{{ $proposalLabel }}</td>
                    <td width="34%" align="center">PAGE 3</td>
                    <td width="33%" align="right">Generated by {{ $originalCompanyName }}</td>
                </tr>
            </table>
        </div>
    ...
    <section class="page proposal-page no-header-page">
        ...
        <div class="prop-footer">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="33%" align="left">{{ $proposalLabel }}</td>
                    <td width="34%" align="center">PAGE 4</td>
                    <td width="33%" align="right">Generated by {{ $originalCompanyName }}</td>
                </tr>
            </table>
        </div>
    ...
    <section class="page proposal-page no-header-page">
        ...
        <div class="prop-footer">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="33%" align="left">{{ $proposalLabel }}</td>
                    <td width="34%" align="center">PAGE {{ 5 + ($datasheetCount ?? 0) }}</td>
                    <td width="33%" align="right">Generated by {{ $originalCompanyName }}</td>
                </tr>
            </table>
        </div>
    ...
    <section class="page proposal-page no-header-page">
        ...
        <div class="prop-footer">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="33%" align="left">{{ $proposalLabel }}</td>
                    <td width="34%" align="center">PAGE {{ $pageOffset + $index }}</td>
                    <td width="33%" align="right">Generated by {{ $originalCompanyName }}</td>
                </tr>
            </table>
        </div>
    ...
    <section class="page proposal-page no-header-page">
        ...
        <div class="prop-footer">
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="33%" align="left">{{ $proposalLabel }}</td>
                    <td width="34%" align="center">PAGE {{ 6 + ($datasheetCount ?? 0) }}</td>
                    <td width="33%" align="right">Generated by {{ $originalCompanyName }}</td>
                </tr>
            </table>
        </div>
